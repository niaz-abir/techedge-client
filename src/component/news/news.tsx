...
const News = () => {
  return (
    <section className="mt-14">
      <h1 className="text-3xl text-[#247AB0] pl-4 font-bold lg:pl-12 ">
        Our some Achievement
      </h1>
      <div className="mb-8">
        <div className="px-5 py-10 text-white">
          <div className="container grid grid-cols-12 mx-auto gap-y-6 md:gap-10">
              ...
              <div className="flex flex-col space-y-8 md:space-y-12">
                <div className="flex flex-col space-y-2">
                  <h3 className="flex items-center space-x-2 dark:text-gray-400">
                    ...
                    <span className="text-xs font-bold uppercase tracki">
                      Exclusive
                    </span>
                  </h3>
                  <a
            ...
            <div
              ...
              style={{
                backgroundImage: `url('https://images.unsplash.com/photo-1607270788732-55d2cdb8f52a?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')`,
              }}
            >
              ...
              <a className="flex flex-col items-center justify-end p-6 text-center sm:p-8 group dark:via-transparent flex-grow-1 bg-gradient-to-b dark:from-gray-900 dark:to-gray-900">
                ...
                >
                  Helping people . Its not a work its dream for lot of people
                  who know
                </h1>
              </a>
            </div>
              ...
              <div className="flex flex-col divide-y dark:divide-gray-700">
                <div className="flex px-1 py-4">
                  <img
                    ...
                    src="https://images.unsplash.com/photo-1610664921890-ebad05086414?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                  />
                ...
                <div className="flex px-1 py-4">
                  <img
                    alt=""
                    className="flex-shrink-0 object-cover w-20 h-20 mr-4 dark:bg-gray-500"
                    src="https://images.unsplash.com/photo-1557046921-071f5864bafc?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                  />
                  <div className="flex flex-col flex-grow">
                    <a
                      rel="noopener noreferrer"
                ...
                <div className="flex px-1 py-4">
                  <img
                    alt=""
                    className="flex-shrink-0 object-cover w-20 h-20 mr-4 dark:bg-gray-500"
                    src="https://images.unsplash.com/photo-1616410011236-7a42121dd981?q=80&w=1632&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                  />
                  <div className="flex flex-col flex-grow">
                    <a
                      rel="noopener noreferrer"
